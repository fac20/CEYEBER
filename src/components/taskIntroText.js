export const task1 = {
  title: '1st Case: Troll Hunter',
  bubble: 'Your friend Sam has sent you a video',
  message:
    'You need to make a decision of what to do with this information. Make sure you choose the right one!'
};
